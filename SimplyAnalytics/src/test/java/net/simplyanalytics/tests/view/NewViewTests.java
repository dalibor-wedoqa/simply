...
public class NewViewTests extends TestBase {
  ...
  public static List<ViewType[]> data() {
    ...
    for (ViewType viewType : ViewType.values()) {
      //TODO fix for Crosstab -> cause data adding is missing and there is no toolbar after view creation
  ...
  public NewViewTests(ViewType view) {
    this.view = view;
  }
