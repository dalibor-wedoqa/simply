...
public class TimeSeriesExportTests extends TestBase {

  private static final ViewType viewType = ViewType.TIME_SERIES;

  private final String excelMessage = "Excel Email Message - Time Series "
      + randomNumericStringGenerator.generate(4);

  private final String csvMessage = "CSV Email Message - Time Series "
      + randomNumericStringGenerator.generate(4);

  private final String dbfMessage = "DBF Email Message - Time Series "
      + randomNumericStringGenerator.generate(4);
  ...
  private EditTimeSeriesPage editTimeSeriesPage;
  ...
  public void testExcelEmailExport() throws Exception {
    ...
    editTimeSeriesPage = (EditTimeSeriesPage) newViewPage.getActiveView().clickCreate(viewType);

    timeSeriesPage = (TimeSeriesPage) editTimeSeriesPage.clickDone();

    timeSeriesPage.getLdbSection().clickLocationsEnterSearchAndChooseARandomNumberLocation("Chi", 4);

    exportWindow = timeSeriesPage.getToolbar().clickExport();
    ...
    Assert.assertEquals("Message is missing", 
        "Your export is being processed.You will receive an email shortly.", timeSeriesPage.getAlertMessage());
    ...
    verificationStep("Verify that the Excel Time Series Report was successfully exported to email");
    Assert.assertTrue("The selected Time Series Report was not exported",
    ...
    List<List<String>> tableContent = timeSeriesPage.getActiveView().getTableContents();
  ...
  public void testCsvEmailExport() throws Exception {
    ...
    timeSeriesPage.getLdbSection().clickLocationsEnterSearchAndChooseARandomNumberLocation("Chi",
        4);
    ...
    verificationStep("Verify that the CSV Time Series Report was successfully exported to email");
    Assert.assertTrue("The selected Time Series Report was not exported",
  ...
  public void testDbfEmailExport() throws Exception {
    ...
    verificationStep("Verify that the BDF Time Series Report was successfully exported to email");
    Assert.assertTrue("The selected Time Series Report was not exported",
  ...
  public void testExcelDownloadExport() throws Exception {
    ...
    verificationStep("Verify that the Excel Time Series Report was successfully downloaded");
  ...
  public void testCsvDownloadExport() throws Exception {
    ...
    verificationStep("Verify that the CSV Time Series Report was successfully downloaded");
    Assert.assertNotEquals("The selected Time Series Report was not exported", file, null);
  ...
  public void testDbfDownloadExport() throws Exception {
    ...
    verificationStep("Verify that the BDF Time Series Report was successfully downloaded");
    Assert.assertNotEquals("The selected Time Series Report was not exported", file, null);
