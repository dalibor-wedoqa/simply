 ...
 * @author wedoqa
 */
public class RelatedDataExportTests extends TestBase {

  private static final ViewType viewType = ViewType.RELATED_DATA;

  private final String excelMessage = "Excel Email Message - Related Data "
      + randomNumericStringGenerator.generate(4);

  private final String csvMessage = "CSV Email Message - Related Data "
      + randomNumericStringGenerator.generate(4);

  private final String dbfMessage = "DBF Email Message - Related Data "
      + randomNumericStringGenerator.generate(4);
  ...
  private EditRelatedDataReportPage editRelatedDataReportPage;
  ...
  public void testExcelEmailExport() throws Exception {
    ...
    editRelatedDataReportPage = (EditRelatedDataReportPage) newViewPage.getActiveView()
        .clickCreate(viewType);

    relatedDataReportPage = (RelatedDataReportPage) editRelatedDataReportPage.clickDone();

    relatedDataReportPage.getLdbSection()
        .clickLocationsEnterSearchAndChooseARandomNumberLocation("Chi", 4);

    exportWindow = relatedDataReportPage.getToolbar().clickExport();
    ...
    Assert.assertEquals("Message is missing", 
        "Your export is being processed.You will receive an email shortly.", relatedDataReportPage.getAlertMessage());
    ...
    verificationStep(
        "Verify that the Excel Related Data Report was successfully exported to email");
    Assert.assertTrue("The selected Related Data Report was not exported",
    ...
    relatedDataReportPage.getActiveView().openColumnHeaderDropdown("Data Variable").clickSortByDataVariables();
    
    List<List<String>> tableContent = relatedDataReportPage.getActiveView().getTableContents();
  ...
  public void testCsvEmailExport() throws Exception {
    ...
    verificationStep("Verify that the CSV Related Data Report was successfully exported to email");
    Assert.assertTrue("The selected Related Data Report was not exported",
  ...
  public void testDbfEmailExport() throws Exception {
    ...
    verificationStep("Verify that the BDF Related Data Report was successfully exported to email");
    Assert.assertTrue("The selected Related Data Report was not exported",
  ...
  public void testExcelDownloadExport() throws Exception {
    ...
    verificationStep("Verify that the Excel Related Data Report was successfully downloaded");
    Assert.assertNotEquals("The selected Related Date was not exported", file, null);
  ...
  public void testCsvDownloadExport() throws Exception {
    ...
    verificationStep("Verify that the CSV Related Data Report was successfully downloaded");
    Assert.assertNotEquals("The selected Related Data Report was not exported", file, null);
  ...
  public void testDbfDownloadExport() throws Exception {
    ...
    verificationStep("Verify that the BDF Related Data Report was successfully downloaded");
    Assert.assertNotEquals("The selected Related Data Report was not exported", file, null);
