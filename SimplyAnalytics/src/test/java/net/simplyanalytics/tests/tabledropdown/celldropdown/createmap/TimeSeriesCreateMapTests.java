...
public class TimeSeriesCreateMapTests extends TestBase {
  ...
  private final String expectedDataVariable = firstDefaultDataVariable.getFullName();
  ...
  public void testCreateMap() {   
    ...
    CellDropdown cellDropdown = timeSeriesPage.getActiveView().openCellDropdown(expectedDataVariable,
