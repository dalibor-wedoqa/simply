...
public class EditHistogramPanel extends BaseEditViewPanel {
  
  /**
   * EditBarChartPanel constructor.
   * @param driver WebDriver
   */
  public EditHistogramPanel(WebDriver driver) {
    super(driver, EditContainerType.NONE, EditContainerType.NONE,
