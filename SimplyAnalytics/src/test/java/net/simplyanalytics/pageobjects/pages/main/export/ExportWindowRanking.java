...
import io.qameta.allure.Step;
   ...
   * @author wedoqa
   */
  public class ExportWindowRanking extends MainExport {
    
    protected static final By ROOT_LOCATOR = By
        .cssSelector("[class*='export-window'] .sa-export-widget:not([style*='visibility: hidden'])");
    protected WebElement root;
    
    @FindBy(css = ".sa-check-field.sa-radio-default")
    private List<WebElement> fileFormats;
    
    @FindBy(css = ".sa-toggle-switch[class*='sa-export-widget-email-or-save-toggle-switch'] div")
    ...
    @FindBy(css = ".sa-simple-container[class*='sa-export-widget-footer'] a")
    private List<WebElement> exportCancelButtons;
    
    public ExportWindowRanking(WebDriver driver) {
    ...
    public boolean isExportToEnabled() {
      return !driver.findElement(By.cssSelector(".sa-export-window-email-or-save-toggle-switch"))
